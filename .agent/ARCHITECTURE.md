...
`node:sqlite` roda em worker dedicado. Banco em `E:\Tupiniquim-AI-Dev-Studio.data\studio.sqlite`, WAL, foreign keys, migrations numeradas e backup em `...\backups`. Writes são serializados.
