...
| 1 | Dev AI local autônomo: runtime local, agente, workspace, memória, contexto e browser QA | EM ANDAMENTO; checkpoint/wave-09 cobre runtime, contexto, baseline, histórico recuperável e manifestos imutáveis de efeitos |
